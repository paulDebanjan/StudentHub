...
# rooms = [
#     {"id":1,"name":"Django Course"},
#     {"id":2,"name":"PHP Course"},
#     {"id":3,"name":"Android Course"},
#     {"id":4,"name":"Java Course"},
#     {"id":5,"name":"Python Course"},
# ]
...
def registerPage(request):
    ...
    if form.is_valid():
        ...
        messages.error(request,'An error accorred durion registration')
...
def updateRoom(request,pk):
    ...
    if request.user != room.host:
        return HttpResponse('You are not owner this post!')
    if request.method == 'POST':
        topic_name = request.POST.get('topic')
        topic,created = Topic.objects.get_or_create(name = topic_name)
